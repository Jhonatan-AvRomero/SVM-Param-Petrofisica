...
columnas = ['Saturacion_agua','Permeabilidad', 'Porosidad']
...
#Grafica de las componentes principales...
print('Resultados PCA: ',resultados_PCA.describe())

plt.figure(figsize=(8,5))
plt.scatter(resultados_PCA[0],resultados_PCA[1], c = registro_completo['Volumen_arcilla'])
plt.colorbar()
plt.show()
...
#resultados_PCA: Datos de salida
...
'''Datos de entrada:
    ...
    1. x_test
    2. y_test'''
#__________________________Escalar Datos_________________________________________
print(resultados_PCA.shape)
columnas = [0,1,'0_zscore','1_zscore']
Conjunto_Vsh_inicial_SVR = resultados_PCA[columnas]
...
Modelo_SVR = svm.SVR(kernel = 'rbf', C = 0.1)
print(Modelo_SVR)
